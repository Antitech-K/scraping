...
import keyword
from bs4 import BeautifulSoup as BS, BeautifulStoneSoup
...
for u in url_item:
    ...
    develiry_date =borsch.find(class_= "snow-ali-kit_Typography__base__1shggo snow-ali-kit_Typography__base__1shggo snow-ali-kit_Typography__sizeTextM__1shggo")
    ...
    print(u)
    print (price.text)
    print (number_buy.text)
    print (review.text)
    for find_text in develiry[:3]:
        print(find_text.text)
    print (develiry_date.text)
    print (type(develiry[0]))
    time.sleep(100)
